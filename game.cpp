...
internal void simulate_game(Input* input, float dt) {
	draw_rect(0, 0, arena_half_size_x, arena_half_size_y, 0x98ccfa);
	draw_arena_borders(arena_half_size_x, arena_half_size_y, 0x1472c4);
	...
	if (current_gamemode == GM_GAMEPLAY) {
		...
		draw_number(player_1_score, -10, 40, 1.f, 0x05ff71);
		draw_number(player_2_score, 10, 40, 1.f, 0x05ff71);

		// Rendering
		draw_rect(ball_p_x, ball_p_y, ball_half_size, ball_half_size, 0xffffff);

		draw_rect(80, player_1_p, player_half_size_x, player_half_size_y, 0xa128fc);
		draw_rect(-80, player_2_p, player_half_size_x, player_half_size_y, 0xa128fc);
